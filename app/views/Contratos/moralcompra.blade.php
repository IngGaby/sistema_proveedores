        ...
        <div class="col-md-10">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Contrato persona moral compra-venta</h3>
                </div>
                ...
                <table class="table">
                    ...
                    @foreach ($registros as $registro)
                        <tr>
                            ...
                            <td><a href="{{ url('/contratomoralcompra/'.$registro->no_contrato) }}" class="btn btn-success">Ver Contrato</a></td>
                        </tr>
                    @endforeach
                </table>
            </div>
