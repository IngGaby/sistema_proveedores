...
class Alta_MoralController extends BaseController{
	...
	public function guardarMoral()
	{
		...
		$reglas = [
			...
			'numeroacta'			  =>'required|integer',
			'numeronotario'		  =>'required|integer',
		...
		$messages = [
			...
			'numeroacta.integer'			  => 'El número de acta debe ser númerico',
			'numeronotario.required'		  => 'El número de notario es un campo requerido',
			'numeronotario.integer'		 	  => 'El numero de notario debe serun campo númerico',
